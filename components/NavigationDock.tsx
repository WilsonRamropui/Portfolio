...
export function NavigationDock() {
  ...
  return (
    <header className="flex sticky top-0 z-50 w-full max-w-[100vw] overflow-hidden border-b border-white/10 bg-zinc-950/30 backdrop-blur-xl backdrop-saturate-150 py-2 md:py-3 px-4 md:px-8 items-center justify-end shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] relative">
